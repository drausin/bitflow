...
public class BitcoindRpcRequestMapperProvider implements ContextResolver<ObjectMapper> {

    private final ObjectMapper mapper;

    public BitcoindRpcRequestMapperProvider() {
    ...
    public static SimpleModule getModule() {
        return new SimpleModule("BitcoindRpcRequest", Version.unknownVersion())
